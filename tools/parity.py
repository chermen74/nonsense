...
CHECKS = [
    ...
    ("strike time",       r"const val STRIKE_TIME\s*=",   r"static let strikeTime\s*=",             "n"),
    ("noise cutoff",      r"const val NOISE_HZ\s*=",     r"static let noiseHz\s*=",                "n"),
    ("noise cutoff grit", r"const val NOISE_HZ_GRIT\s*=", r"static let noiseHzGrit\s*=",            "n"),
    ("noise makeup",      r"const val NOISE_MAKEUP\s*=", r"static let noiseMakeup\s*=",            "n"),
